...
export default connect(
  ...
  (dispatch) => ({
    createReaction: (id, reaction, user_id, single) => dispatch(
      createReaction(id, reaction, user_id, single),
    ),
    ...
    updateReaction: (id, reaction, user_id, single) => dispatch(
      updateReaction(id, reaction, user_id, single),
    ),
    deleteReaction: (id, reaction, user_id, single) => dispatch(
      deleteReaction(id, reaction, user_id, single),
    ),
  }),
)(ProjectsBrowse);
